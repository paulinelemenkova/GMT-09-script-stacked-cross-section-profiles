...
echo "150 -2000 Greater Kuril Chain" | gmt pstext -R -J -Gwhite -F+jTC+f9p -O -K >> $ps
echo "-150 -6000 Pacific Plate" | gmt pstext -R -J -Gwhite -F+jTC+f9p -O -K >> $ps
